...
document.write("<script>if (typeof goog != \"undefined\") { goog.require(\"figwheel.connect.build_index\"); }</script>");
document.write('<script>goog.require("zhuzha.cljs.index");</script>');